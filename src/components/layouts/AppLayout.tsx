...
const NAV: NavItem[] = [
   { to: "/app", label: "Dashboard", icon: LayoutDashboard, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/agenda", label: "Agenda", icon: CalendarClock, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/leads", label: "Leads & Funil", icon: Kanban, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/boards", label: "Meus Kanbans", icon: KanbanSquare, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/mentorados", label: "Mentorados", icon: Users, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/tests", label: "Testes", icon: ClipboardList, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/quiz", label: "Quizzes PVP", icon: Zap, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/meetings", label: "Reuniões", icon: Calendar, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowMeetings" },
   { to: "/app/scheduling", label: "Agenda Pública", icon: CalendarDays, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowScheduling" },
   { to: "/app/tasks", label: "Tarefas", icon: CheckSquare, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/billing", label: "Cobranças", icon: DollarSign, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowMentorBilling" },
   { to: "/app/trails", label: "Trilhas", icon: GraduationCap, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowTrails" },
   { to: "/app/access-groups", label: "Grupos de Acesso", icon: Users, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/community", label: "Comunidade", icon: Users, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowCommunity" },
   { to: "/app/analytics", label: "Analytics", icon: Sparkles, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowAdvancedAnalytics" },
   { to: "/app/messages/templates", label: "Mensagens", icon: MessageSquare, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowMessaging" },
   { to: "/app/whatsapp/groups", label: "Grupos WhatsApp", icon: Users, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowWhatsapp" },
   { to: "/app/automations", label: "Automações", icon: Zap, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowAutomations" },
   { to: "/app/team", label: "Equipe", icon: Users, roles: ["mentor", "super_admin", "admin"] },
   { to: "/app/contents", label: "Conteúdos", icon: BookOpen, roles: ["mentor", "super_admin", "admin", "editor"] },
   { to: "/app/ai", label: "Assistente IA", icon: Sparkles, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowAi" },
   { to: "/app/prompts", label: "Prompts", icon: BookOpen, roles: ["mentor", "super_admin", "admin", "editor", "attendant"], feature: "allowAi" },
   { to: "/app/capture", label: "Captação / QR", icon: QrCode, roles: ["mentor", "admin"] },
   { to: "/app/events", label: "Eventos", icon: CalendarDays, roles: ["mentor", "super_admin", "admin", "editor", "attendant"] },
   { to: "/app/contracts/templates", label: "Contratos", icon: FileText, roles: ["mentor", "super_admin", "admin"] },
   { to: "/app/integrations", label: "Integrações", icon: Plug, roles: ["mentor", "super_admin", "admin"] },
   { to: "/app/settings/branding", label: "Branding", icon: Settings, roles: ["mentor", "super_admin", "admin"] },
