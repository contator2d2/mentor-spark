     ...
     <div className="min-h-screen grid md:grid-cols-2 bg-background">
       <div className="hidden md:flex bg-sidebar text-sidebar-foreground p-12 flex-col justify-between relative overflow-hidden">
         <div className="absolute inset-0 bg-grid opacity-20" />
          <Link to="/" className="font-display text-2xl font-bold relative z-10">Mentor Glee-go</Link>
         <div className="relative z-10">
          ...
          <div className="text-sm text-sidebar-foreground/50 relative z-10">© {new Date().getFullYear()} Mentor Glee-go</div>
       </div>
